//https://cdn.datatables.net/1.10.11/js/dataTables.bootstrap4.min.js
/*!
...
(function (b) {
    ...
    var DataTable = b.fn.dataTable;
    b.extend(!0, DataTable.defaults, {
        dom: "<'row'<'col-md-6'l><'col-md-6'f>><'row'<'col-md-12'tr>><'row'<'col-md-5'i><'col-md-7'p>>",
        renderer: "bootstrap"
    });
    b.extend(DataTable.ext.classes, {
    ...
    DataTable.ext.renderer.pageButton.bootstrap = function (a, h, r, m, j, n) {
        var o = new DataTable.Api(a),
            s = a.oClasses,
